...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <i class="fab fa-google fa-fw dark"></i>
                </div>
                <div class="sidebar-brand-text mx-3"><span class="text-primary">G</span><span class="text-danger">o</span><span class="text-warning">o</span><span class="text-primary">g</span><span class="text-success">l</span><span class="text-danger">e</span> API</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="review.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="angrybirds.html">Angry Birds</a>
                        <a class="collapse-item" href="angrybirds2.html">Angry Birds 2</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">A user named Zikri has been given a new
                                            Review</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        A user named Zikri has been update a Review
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        A user named Zikri has been given a new Review
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" id="pic">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Zikri Endisyah Munandar 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script>
        function signOut() {
            ...
            auth2.signOut().then(function() {
                window.location.replace("http://zikriapi.000webhostapp.com/")
    ...
    <div class="modal fade" id="add_items" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Reply to Review</h5>
                ...
                <div class="modal-body">
                    <form action="submit" method="post">
                        <div class="form_group">
                            <label>Reply</label>
                            <textarea name="reply" class="form-control">Reply</textarea>
                        </div>
                </div>
                <div class="modal-footer">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">AndroidVersion</th>
                                <th scope="col">AppVersionCode</th>
                                <th scope="col">DevReply</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
